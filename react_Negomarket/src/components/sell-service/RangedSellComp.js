  ...
  return (
    <div style={{display: 'inline-block', width: '225px', height: '280px', padding: '12px'}}>
        <div className='imageBox-sm' style={{width: '225px', height: '225px'}}>
          <Link to={`/board/detail/${rangedSell.id}`}><img style={{width: '225px', height: '225px'}} src={`http://${API_URL}:8000/sell-service/img/${rangedSell.id}`} onError={handleError} alt=''/></Link></div>
