...
class BoardInsert extends StatefulWidget {
  final Function(HomeIndexProvider, int) naviIndexCallback;
  const BoardInsert({Key? key, required this.naviIndexCallback}) : super(key: key);
...
class _BoardInsertState extends State<BoardInsert> {
  ...
  Future<BoardResponse> insertBoard(ImageProvider imageProvider) async {
    ...
    if (response.statusCode == 200) {
      ...
      widget.naviIndexCallback(Provider.of<HomeIndexProvider>(context, listen: false), 0);
    ...
    return ChangeNotifierProvider(
      ...
      child: Column(
        children: [
          ...
          Container(
            decoration: BoxDecoration(color: Color.fromRGBO(190, 10, 10, 0.1)),
                    ...
                    builder: (context, imageProvider, child) {
                      return GestureDetector(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ListTile(
                                        ...
                                        title: Text('Gallery'),
                                        onTap: () async {
                                          _pickSellImage(1, imageProvider);
                                          Navigator.pop(
                                      ...
                                      ListTile(
                                        ...
                                        title: Text('Camera'),
                                        onTap: () async {
                                          _pickSellImage(2, imageProvider);
                                          Navigator.pop(
                                              context); // 선택 후 바닥 시트를 닫습니다.
                                        },
                                      ),
                        ...
                        child: Container(
                          ...
                          child: imageProvider._imageFile == null
                              ? Center(child: Text('탭하여 이미지 설정'))
                              : Image.file(
                                  File(imageProvider._imageFile!.path)),
                        ),
                      );
                    },
                  ),
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ListTile(
                                      ...
                                      onTap: () async {
                                        String id =
                                            await _pickImageAndUpload(1);
                                        if (id != "") {
                                          insertImage(_quillController,
